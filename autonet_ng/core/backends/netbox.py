...
from autonet_ng.core.backends.base import AutonetDeviceBackend
from autonet_ng.core.device import AutonetDevice, AutonetDeviceCredentials
...
class NetBox(AutonetDeviceBackend):
    ...
    def get_device(self, device_id) -> Union[None, AutonetDevice]:
        ...
        if 'autonet_ng' in device['config_context']:
            metadata = {**metadata, **device['config_context']['autonet_ng']}
