...
from autonet_ng.core.backends.netbox import NetBox
...
def marshal_device(device_id):
    ...
    :return:
    """
    # Future versions of autonet_ng may allow multiple, possibly simultaneous, backends
...
def marshal_device_driver(device: AutonetDevice):
    ...
    """
    try:
        for driver_ep in __import__('pkg_resources').iter_entry_points(group='autonet_ng.drivers'):
