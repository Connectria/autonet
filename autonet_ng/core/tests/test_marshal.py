...
def test_marshal_device(monkeypatch, autonet_device):
    ...
    :return:
    """
    from autonet_ng.core.tests.conftest import MockBackend
    import autonet_ng.core.marshal as cm
...
def test_marshal_device_not_found(monkeypatch, autonet_device):
    ...
    :return:
    """
    from autonet_ng.core.exceptions import DeviceNotFound as TestedException
    from autonet_ng.core.tests.conftest import MockBackend
    import autonet_ng.core.marshal as cm
...
def test_marshal_device_credentials_not_found(monkeypatch, autonet_device):
    ...
    :return:
    """
    from autonet_ng.core.exceptions import DeviceCredentialsNotFound as TestedException
    from autonet_ng.core.tests.conftest import MockBackend
    import autonet_ng.core.marshal as cm
...
def test_marshal_device_credentials_not_found(monkeypatch, autonet_device):
    ...
    :return:
    """
    from autonet_ng.core.exceptions import DeviceDriverNotFound as TestedException
    from autonet_ng.core.tests.conftest import MockBackend
    import autonet_ng.core.marshal as cm
...
def test_marshal_device_driver(autonet_device):
    from autonet_ng.core.marshal import marshal_device_driver
    from autonet_ng.drivers.dummy_driver.driver import DummyDriver
